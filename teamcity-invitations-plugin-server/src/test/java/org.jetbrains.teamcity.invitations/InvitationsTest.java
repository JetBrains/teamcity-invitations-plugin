...
public class InvitationsTest extends BaseTestCase {
    ...
    public void invite_user_to_create_a_project() throws Exception {
        String token = inviteToCreateProject("PROJECT_ADMIN", "TestDriveProjectId", true);
    ...
    public void invite_user_to_join_the_project() throws Exception {
        String token = inviteToJoinProject("PROJECT_DEVELOPER", "TestDriveProjectId", true);
    ...
    public void should_survive_server_restart() {
        String token1 = inviteToCreateProject("PROJECT_ADMIN", "TestDriveProjectId", true);
        String token2 = inviteToJoinProject("PROJECT_DEVELOPER", "_Root", false);
    ...
    public void single_user_invitation_can_be_used_once() throws Exception {
        String token = inviteToCreateProject("PROJECT_ADMIN", "TestDriveProjectId", false);
    ...
    private String inviteToCreateProject(String role, String parentExtId, boolean multiuser) {
    ...
    private String inviteToJoinProject(String role, String projectExtId, boolean multiuser) {
        newRequest(HttpMethod.POST, "/admin/invitations.html?createInvitation=1");
